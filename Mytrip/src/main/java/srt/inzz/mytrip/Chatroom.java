...
public class Chatroom extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences share=this.getSharedPreferences("keynam", MODE_WORLD_READABLE);
		shared_nam=share.getString("srtnam","");
		
		SharedPreferences share1=getSharedPreferences("mKey", MODE_WORLD_READABLE);
		shared_uid=share1.getString("keyvid", "");
	    ...
	    public class MessageRecApiTask extends AsyncTask<String,String,String> {
		    ...
		    protected void onPostExecute(String s) {
		      ...
		      //  linlaHeaderProgress.setVisibility(View.GONE);
		        ...
		        {
		        	Toast.makeText(getApplicationContext(), "Network Error, Try again later..", 
