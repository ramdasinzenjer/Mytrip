...
public class RegisterApiTask extends AsyncTask<String,String,String> {
  //  private ProgressDialog progressDialog;
    Context ctx;
    String email,password,name,user_id,phone,license,vehicleid,vtyp;
    ...
    public RegisterApiTask(Context context, String email, String name, String pass, String phn, String uid,String licen, String vehid,String svtyp, OnRegisterTaskCompleted onRegisterTaskCompleted) {
        this.ctx=context;
        this.email=email;
        this.password=pass;
        this.name=name;
    ...
    protected String doInBackground(String... params) {
            ...
            try {
                urlParameters = "email=" + URLEncoder.encode(email, "UTF-8") + "&&"
                        ...
                        + "veh_type=" + URLEncoder.encode(vtyp, "UTF-8") + "&&"
